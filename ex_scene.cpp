...
void EX_Scene::paintEvent(QPaintEvent *){
    ...
    //地图滚动
    p.drawPixmap(QRect(0,this->groundY,this->width(),groundImg.height())
                 ,groundImg
                 ,QRect(curgroundImgX,0,this->width(),groundImg.height()));
    if(curgroundImgX>groundImg.width()-this->width())
        p.drawPixmap(QRect(groundImg.width()-curgroundImgX,this->groundY,this->width()-(groundImg.width()-curgroundImgX),groundImg.height())
                     ,groundImg
                     ,QRect(0,0,this->width()-(groundImg.width()-curgroundImgX),groundImg.height()));
